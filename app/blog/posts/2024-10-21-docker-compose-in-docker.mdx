...
[Docker Compose On Fly.io](https://github.com/zachblume/docker-compose-on-fly-io)
...
Here’s the approach I took:
    ...
    1.	Creating a Custom Image: I built a Docker image that included both Docker and Docker Compose installed. This image would serve as the environment to run my docker-compose.yml file. I had to use a builder with a custom buildx configuration to run it as priveleged.
