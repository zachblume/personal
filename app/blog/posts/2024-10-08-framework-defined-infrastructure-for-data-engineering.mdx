...
internal data management. But I think a framework where you write dashboards,
sql models, and external connections the way you want them instead of spending
time writing plumbing would be a preferred workflow for me, and I think we're
in an interesting place where the existing open-core solutions like dbt maybe
